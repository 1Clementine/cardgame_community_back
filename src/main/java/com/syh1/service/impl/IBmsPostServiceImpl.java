...
import com.syh1.mapper.BmsTagMapper;
...
import com.syh1.model.entity.BmsTag;
import com.syh1.model.entity.BmsTopicTag;
...
import com.syh1.service.IBmsTagService;
...
public class IBmsPostServiceImpl extends ServiceImpl<BmsTopicMapper, BmsPost> implements IBmsPostService {
    ...
    @Autowired
    private com.syh1.service.IBmsTopicTagService IBmsTopicTagService;
    @Override
    ...
    @Override
    @Transactional(rollbackFor = Exception.class)//事务处理（涉及多个表的操作）
